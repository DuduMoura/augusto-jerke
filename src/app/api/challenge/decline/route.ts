...
export async function PUT(req: NextRequest) {
  ...
  const challenge = await prisma.challenge.findUnique({
    ...
    include: {
      ...
      challenged_user: { select: { id: true, name: true, points: true } },
    },
  });
  ...
  await prisma.$transaction([
    ...
    prisma.history.create({
      data: {
        ...
        description: `Desafio recusado por ${challenge.challenged_user.name}. +5 pontos`,
        points: 5,
      },
    }),
    prisma.history.create({
